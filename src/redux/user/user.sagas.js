...
export function* signInFailureAlert({payload}) {
...
export function* onSignInFailure() {
	yield takeLatest(UserActionTypes.SIGN_IN_FAILURE, signInFailureAlert);
}

export function* onSignUpFailure() {
	yield takeLatest(UserActionTypes.SIGN_UP_FAILURE, signInFailureAlert);
}
